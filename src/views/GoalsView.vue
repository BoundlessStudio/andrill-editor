...
import { useStore as useStoreGoals } from "@/stores/GoalsEditor"

let goalsStore = useStoreGoals()
const { item } = storeToRefs(goalsStore)
provide('store', goalsStore)
provide('prefix', "Abstract")
provide('name', "Goal")
provide('help', "This is a friendly little box that will tell the you how goals works")
