...
let beliefsStore = useStoreBeliefs()
const { item } = storeToRefs(beliefsStore)
provide('store', beliefsStore)
provide('prefix', "Abstract")
provide('name', "Belief")
provide('help', "This is a friendly little box that will tell the you how beliefs works")
