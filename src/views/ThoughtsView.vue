...
import { useStore as useStoreThoughts } from "@/stores/ThoughtsEditor"

let thoughtsStore = useStoreThoughts()
const { item } = storeToRefs(thoughtsStore)
provide('store', thoughtsStore)
provide('prefix', "Abstract")
provide('name', "Thought")
provide('help', "This is a friendly little box that will tell the you how thoughts works")
