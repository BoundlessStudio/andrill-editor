...
import { useStore as useStoreHooks } from "@/stores/HooksEditor"

let HooksStore = useStoreHooks()
const { item } = storeToRefs(HooksStore)
provide('store', HooksStore)
provide('prefix', "Communication")
provide('name', "Hooks")
provide('help', "This is a friendly little box that will tell the you how hooks works")
