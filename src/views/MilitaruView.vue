...
import { useStore as useStoreMilitary } from "@/stores/MilitaryEditor"

let militaryStore = useStoreMilitary()
const { item } = storeToRefs(militaryStore)
provide('store', militaryStore)
provide('prefix', "Abstract")
provide('name', "Military")
provide('help', "This is a friendly little box that will tell the you how military works")
