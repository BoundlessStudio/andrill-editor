...
import { useStore as useStoreSites } from "@/stores/SitesEditor"

let sitesStore = useStoreSites()
const { item } = storeToRefs(sitesStore)
provide('store', sitesStore)
provide('prefix', "Abstract")
provide('name', "Site")
provide('help', "This is a friendly little box that will tell the you how sites works")
