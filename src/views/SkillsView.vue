...
import { useStore as useStoreSkills } from "@/stores/SkillsEditor"

let skillsStore = useStoreSkills()
const { item } = storeToRefs(skillsStore)
provide('store', skillsStore)
provide('prefix', "Abstract")
provide('name', "Skill")
provide('help', "This is a friendly little box that will tell the you how skills works")
