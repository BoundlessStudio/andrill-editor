...
import { useStore as useStoreVerbs } from "@/stores/VerbsEditor"

let verbStore = useStoreVerbs()
const { item } = storeToRefs(verbStore)
provide('store', verbStore)
provide('prefix', "Communication")
provide('name', "Verb")
provide('help', "This is a friendly little box that will tell the you how verbs works")
