...
import { useStore as useStoreNeeds } from "@/stores/NeedsEditor"

let needsStore = useStoreNeeds()
const { item } = storeToRefs(needsStore)
provide('store', needsStore)
provide('prefix', "Abstract")
provide('name', "Need")
provide('help', "This is a friendly little box that will tell the you how needs works")
