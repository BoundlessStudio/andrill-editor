...
import { useStore as useStoreReligions } from "@/stores/ReligionsEditor"

let religionStore = useStoreReligions()
const { item } = storeToRefs(religionStore)
provide('store', religionStore)
provide('prefix', "Abstract")
provide('name', "Religion")
provide('help', "This is a friendly little box that will tell the you how religion works")
