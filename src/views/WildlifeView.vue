...
import { useStore as useStoreWildlife } from "@/stores/WildlifeEditor"

let wildlifeStore = useStoreWildlife()
const { item } = storeToRefs(wildlifeStore)
provide('store', wildlifeStore)
provide('prefix', "Creatures")
provide('name', "Wildlife")
provide('help', "This is a friendly little box that will tell the you hhow wildlife works")
