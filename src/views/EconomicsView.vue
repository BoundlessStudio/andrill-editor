...
import { useStore as useStoreEconomics } from "@/stores/EconomicsEditor"

let economicsStore = useStoreEconomics()
const { item } = storeToRefs(economicsStore)
provide('store', economicsStore)
provide('prefix', "Abstract")
provide('name', "Economic")
provide('help', "This is a friendly little box that will tell the you how economics works")
