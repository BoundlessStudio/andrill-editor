...
import { useStore as useStoreAttributes } from "@/stores/AttributesEditor"

let attributesStore = useStoreAttributes()
const { item } = storeToRefs(attributesStore)
provide('store', attributesStore)
provide('prefix', "Abstract")
provide('name', "Attribute")
provide('help', "This is a friendly little box that will tell the you how attributes works")
